...
<p>
  ...
  <a href="https://github.com/stephenlclarke/container/actions/workflows/merge-build.yml?query=branch%3Amain+event%3Apush"><img alt="CI" src="https://github.com/stephenlclarke/container/actions/workflows/merge-build.yml/badge.svg?branch=main&amp;event=push" /></a>
...
gap; the green quality gate must not be read as 90% coverage.
