...
[`container-compose` install guide](https://github.com/stephenlclarke/container-compose/blob/main/docs/guides/INSTALL.md).
Branch, tag, package, and tap behavior is defined only in the
[`container-compose` release guide](https://github.com/stephenlclarke/container-compose/blob/main/docs/guides/BUILD.md).
