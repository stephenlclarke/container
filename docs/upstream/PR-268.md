...
- Reject unresolved new issues and security hotspots in the previous-version period on trusted pull requests and `main`; fork and Dependabot pull requests skip the token-dependent job because repository secrets are unavailable to them.
